...
//                 <body style="font-family: sans-serif; text-align: center; padding: 2rem;">
//                     <h2>Your download is starting...</h2>
//                     <p>If it doesn't, <a href="${file.cloudinaryUrl}" target="_blank" rel="noopener noreferrer">click here</a>
// .</p>
//                 </body>
//             </html>
//         `);
...
//         //  Safe redirect download using Cloudinary
//         res.send(`
//             <html>
//                 <head>
//                     <title>Download File</title>
...
//                 <body style="font-family: sans-serif; text-align: center; padding: 2rem;">
//                     <h2>Your download is starting...</h2>
//                     <p>If it doesn't, <a href="${file.cloudinaryUrl}" target="_blank" rel="noopener noreferrer">click here</a> to download manually.</p>
//                 </body>
//             </html>
//         `);
//     } catch (err) {
